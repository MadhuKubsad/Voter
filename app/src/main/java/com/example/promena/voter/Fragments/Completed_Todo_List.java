...
public class Completed_Todo_List extends Fragment implements View.OnClickListener {
    ...
    private void hit_todo_api() {
        ...
        Call<Todo_Response> todo_responseCall = ApiClient.getClient().create(ApiInterface.class).todoo_response(token);
